        ...
        public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
                http
                                ...
                                .authorizeHttpRequests(authorize -> authorize
                                                ...
                                                .requestMatchers("/css/**","/css/style.css","/.well-known/**","/register", "/register/**", "/", "/articles",
                                                                "/images/**", "/articles/detail/**", "/search/**",
                                                                "/search", "/articles/search", "/articles/articles")
                                                .permitAll()
                                                .requestMatchers("/admin/dashboard", "/categories/create",
                                                                "/categories/edit/**", "/categories/delete/**",
                                                                "/categories/update/**")
                                                .hasRole("ADMIN")
                                                .requestMatchers("/revisor/dashboard", "/revisor/detail/**","/accept")
                                                .hasRole("REVISOR")
                                                .requestMatchers("/writerdashboard", "/articles/create",
                                                                "/articles/edit/**",
